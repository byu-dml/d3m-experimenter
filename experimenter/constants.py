...
problem_directories = [
    ...
    # These two have metadata -- we do only min_metadata problems
...
EXTRA_HYPEREPARAMETERS = {
    "d3m.primitives.feature_selection.generic_univariate_select.SKlearn": [
        {"name": "mode", "argument_type": ArgumentType.VALUE, "data": "fpr"},
        {"name": "param", "argument_type": ArgumentType.VALUE, "data": 0.05},
    ],
}
